...
class AuthService:
    ...
    def can_see_profile(self, userid, commanderid):
        ...
        if h:
            ...
            squad_id = h["squad"]["_id"] if h["squad"] is not None else None
            ...
            for i in commander:
                if i["_id"] == Permissions.COMMANDER and commanderid in i["list"]:
                    ...
                    if i["_id"] == Permissions.SQUAD_LEADER and \
                            commanderid in i["list"].keys() and i["list"][commanderid] == squad_id:
                        return True
