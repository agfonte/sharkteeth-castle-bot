lang_en = {
    ...
    "welcome_no_profile": "Welcome young warrior to the oficial 🦈Sharkteeth Castle Bot.\n\nTo know what to do now "
                          "click on /first\_steps.\n\nFor more information how to use this bot /help.\n\nTo change "
                          "language to English or Spanish press \"⚙️Settings\".",

    "first_steps": "Welcome young sharks, before we can start we need you to do a couple of steps before you can join "
                   "academy and start learning about the game.\n\nThe steps are:\n1- Authorize this bot to "
                   "automatically retreive your profile from ChatWars API: How to do it? -> Just click in /auth, "
                   "you will get a message in your @chtwrsbot with a number, forward that message to me.\n2- Forward "
                   "the message with the pledge invite. If you dont have the message just click /no\_pledge.\n3-("
                   "Optional) Do the same than before but this time with /gearAuth.\n",
    ...
    "whois_wrong_parameters": "If you use /whois on private mode you should pass either the *id* or the *username* of "
                              "the player.",

    "player_not_found": "The requested player does not exist, maybe he just changed his username, try with the `ID`. "
                        "If **ID** was used then the player is not authenticated with the bot.",
    ...
    "enter_squad_forbidden": "User *%s* (with username @%s and id:`%i`) tried to enter in squad *%s*(`%s`) but not "
                             "authorized. Action: *Ban*",
    ...
    "no_username": "To be able to use the bot you need to put an username\n. For it please got to "
                   "Telegram/Settings/Username and select something unique.",

    "change_name": "Battle report are acceptable only with the actual game nick. If you changed your nick, "
                   "please touch /update",
    ...
    "auth_completed_public": "User @%s have been authorized by the CW API. Now I can update his/her profile "
                             "automatically.",

    "auth_completed_gear_public": "User @%s have been authorized by the CW API to see his/her current gear. Now I can "
                                  "update his/her profile automatically.",

    "auth_completed_gear": "You've been authorized by the CW API to see your current gear. Now I can update your "
                           "profile automatically.",

    "auth_completed": "You've been authorized by the CW API. Now I can update your profile automatically.",

    "auth_request": "Now the game bot(@chtwrsbot) will send you a message with the auth code. Forward this message to "
                    "me. If bot is silent, try again in 5 minutes.",

    "squad_create_incorrect_parameters": "Incorrect parameters for the creation of a squad.\n\n The usage is "
                                         "/create_squad Name of Squad,NS",

    "squad_created": "Squad **%s**(`%s`) was created by commander %s.",

    "squad_deleted": "Squad **%s**(`%s`) was deleted by commander %s.",

    "cant_create_squad": "To create a new squad need to be Castle Commander",

    "cant_delete_squad": "To delete a squad is needed to be Castle Commander",

    "squad_exists": "The squad with **id: %s** already exists with the name **%s**.",

    "squad_no_exists": "The squad with **id: %s** does not exists.",
    ...
    "fight_msg": "A fellow player <b>(level %i)</b> is requesting your help to fight this "
    ...
    "my_stats": "⚠️ Remember to send me your /hero when you lvl up\n\nHi brave %s:\n-You are currently %s "
                "fights.\n-Your guild: %s.\n-Your level: %i.\n-Your mobs limits are: %i lvls greater - %i lvls "
                "lower.\n-You only accept help from players with: %i lvl greater - and %i lvls lower.\n-You "
                "succesfuly hunted %i and you missed %i.",
...
Stats: /mystats - To check state and record progress. You will need to send "You are preparing for a fight" and "Too 
late" sms for this to work. 

Stay in touch:
For feedback/bugs contact (@nixth)

For latest updates: (https://t.me/deepsharknews)""",
    "tutorialmsg": """Mob encounters can appear on forest🌲, valley⛰ or swamp🍄. It consists of a fight against 1 to 
    3 forbidden players or animals around your lvl. 

To participate you must use the link in the message, and you can get help by forwarding that message (You can only be 
helped by one person per encounter, and it must be 🦈). Helping consumes 1 stamina 🔋. If you don't click this link 
and no one helps, encounter doesn't occur. 

If you win the encounter you will get some extra exp, and the helper will get slightly more exp than a normal quest.

Helping mobs of 10 lvls lower or more can result on the mob running away, in wich case you and your partner won't get 
exp or rewards. Helping mobs of 10 lvls higher or more can result on both players death. 
